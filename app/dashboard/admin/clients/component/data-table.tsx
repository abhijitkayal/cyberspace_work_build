...
import { UserFormDialog } from "./user-formDialog"
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent className="">
              ...
              <SelectItem value="Author" className="">Author</SelectItem>
              <SelectItem value="Editor" className="">Editor</SelectItem>
              <SelectItem value="Maintainer" className="">Maintainer</SelectItem>
              <SelectItem value="Subscriber" className="">Subscriber</SelectItem>
            </SelectContent>
          </Select>
        </div>
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent className="">
              ...
              <SelectItem value="Basic" className="">
                Basic
              </SelectItem>
              <SelectItem value="Professional" className="">
                Professional
              </SelectItem>
              <SelectItem value="Enterprise" className="">
                Enterprise
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent className="">
              ...
              <SelectItem value="Error" className="">
                Error
              </SelectItem>
