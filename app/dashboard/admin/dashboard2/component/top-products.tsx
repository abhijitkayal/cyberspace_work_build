  ...
  return (
    <Card className="cursor-pointer">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        <div>
          <CardTitle className="">Top Products</CardTitle>
          <CardDescription className="">Best performing products this month</CardDescription>
        </div>
      ...
      <CardContent className="space-y-4">
        {products.map((product, index) => (
          <div key={product.id} className="flex items-center p-3 rounded-lg border border-border/70 gap-2">
