...
/>
        ...
        <BentoCard
          ...
          background={
            ...
            <div className="absolute inset-0 flex items-start justify-center overflow-hidden -mt-15">
            <GlobeDemo />
            </div>
          }
        />
        ...
        <BentoCard
          ...
          className="md:col-span-1"
          background={
            <div className="absolute inset-0 flex items-start justify-center overflow-hidden -mt-30">
  <OrbitingUIAnimation />
</div>
          }
        />
...
function OrbitingUIAnimation() {
  return (
    <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
      <OrbitingCircles iconSize={18} radius={70}>
      ...
      >
        ...
        <BarChart className="text-cyan-500"/>
        <Database className="text-cyan-500"/>
        <Layout className="text-cyan-500"/>
      </OrbitingCircles>

      {/* <div className="absolute h-16 w-16 rounded-full bg-cyan-500/20 backdrop-blur-sm" /> */}
    </div>
  );
}
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-full -mt-13 border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
Circle.displayName = "Circle"
 ...
 function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[300px] w-full items-center justify-center overflow-hidden -pt-20 px-10"
      ref={containerRef}
    >
