            ...
            <div className='space-y-8'>
              ...
              <div className='flex flex-col items-center gap-4'>
                ...
                <div className='text-muted-foreground flex items-center gap-4 text-sm'>
                  ...
                  <span>2M+ Transactions Reconciled</span>
                  <Separator orientation='vertical' className='!h-4' />
              ...
              <div className='space-y-6'>
                <h1 className='text-4xl font-bold tracking-tight text-balance sm:text-5xl lg:text-6xl'>
                  Lock down your company books with 
                ...
                <p className='text-muted-foreground mx-auto max-w-2xl text-balance lg:text-xl'>
                   Stop reconciling manually. Get automated cash matching, vendor settlements, and audit-ready ledgers built for finance teams that can't afford errors.
                </p>
              </div>
