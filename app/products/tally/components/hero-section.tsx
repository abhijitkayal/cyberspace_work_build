...
import { ArrowRight, IdCardLanyard, NotebookTabs, Play, ShoppingBag, Star } from 'lucide-react'
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mb-8 flex justify-center">
            <Badge variant="outline" className="px-4 py-2 border-foreground">
              <NotebookTabs className="w-3 h-3 mr-2 fill-current" />
               Tally Software - Now Available!
