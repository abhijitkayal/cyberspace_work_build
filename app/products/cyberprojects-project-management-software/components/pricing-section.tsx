...
const plans = [
  {
    name: "Basic",
    description: "Perfect for Startups with Limited Resources",
    monthlyPrice: "₹4,000",
    yearlyPrice: "₹40,800",
    lifetimePrice: "₹240,000",
    features: [
"Admin + Staff Dashboard",
"Gantt Chart + Kanban + Tickets",
"Notifications",
"Can add Leads + Clients",
"Shareable Quotation + Invoice + Bill + Contract",
...
"Future Updates",
  ...
  },
  {
    ...
    monthlyPrice: "₹8,000",
    yearlyPrice: "₹76,800",
    lifetimePrice: "₹480,000",
    features: [
    "Everything in Basic Plus:",
"Own Branding",
"HR + Manager + Customer Support + Staff + Partner/Vendor",
"In Platform Shareable and Downalodable Notes + Grids ",
"Message + Attendance Feature",

"Mac + Windows App",
"Android + iOS (Coming Soon) App",
"24/7 Support",
  ...
  },
  {
    name: "Enterprise",
    description:
      " Perfect for Tailored Solutions",
    monthlyPrice: "Custom",
    yearlyPrice: "Custom",
