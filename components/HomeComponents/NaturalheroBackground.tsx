...
export const NeutralHeroBackground = ({ className }: { className?: string }) => {
    ...
    useEffect(() => {
        ...
        const calculateParticleCount = () => {
            ...
            if (count === 0) {
                console.warn("Particle count calculated as 0, using minimum of 50");
                return 50;
            }
            return count;
        };
        ...
        // Initial setup with a small delay to ensure layout is ready
    ...
    return (
        ...
        .accent-lines {
            ...
            z-index: -2;
            --accent-lines-clr: #374151; 
        }
        
        :global(.dark) .accent-lines {
             --accent-lines-clr: rgba(255, 255,255, 255);
        }
      ...
      `}</style>
            ...
            {/* Background Colors */}
            <div className="absolute inset-0 dark:bg-black -z-10 transition-colors duration-300" />
