...
//             <ul className="space-y-2 text-slate-900 text-sm sm:text-base">
//               {[
//                 { href: "/products/ai-intelligent-systems", label: "CyberDine" }, // ✅ Added first
//                 { href: "/products/web-development", label: "CyberPharma" },
//                 { href: "/products/app-development", label: "CyberPayroll" },
//                 { href: "/products/software-development", label: "CyberProjects" },
//                 { href: "/products/ui-ux-design", label: "CyberRetail" },
//                 { href: "/products/digital-marketing", label: "CyberClinic" },
//                 { href: "/products/graphic-design", label: "CyberLedger" },
//                 { href: "/products/research-and-analytics", label: "CyberInvoice" },
//               ].map((item) => (
//                 <li key={item.href}>
//                   <Link
//                     href={item.href}
...
const Footer = () => {
  ...
  if (pathName.startsWith("/dashboard") || pathName === "/schedule" || pathName === "/login" || pathName === "/signup") {
    return null;
  }
      ...
      <div className="max-w-7xl mx-auto bg-gradient-to-r from-cyan-400 via-cyan-400/90 to-cyan-400/70 text-black rounded-3xl p-6 sm:p-8 md:p-10 flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 md:gap-10 text-center sm:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-900 text-sm sm:text-base">
              {[
                { href: "/products/cyberdine-restaurant-management-system", label: "CyberDine" }, // ✅ Added first
                { href: "/products/cyberpharma-pharmacy-management-system", label: "CyberPharma" },
                { href: "/products/cyberclinic-clinic-management-system", label: "CyberClinic" },
                { href: "/products/cyberretail-store-management-system", label: "CyberRetail" },
                { href: "/products/cyberpayroll-hr-management-software", label: "CyberPayroll" },
                { href: "/products/cyberledger-accounting-software", label: "CyberLedger" },
                { href: "/products/cyberinvoice-gst-billing-software", label: "CyberInvoice" },
                { href: "/products/cyberprojects-project-management-software", label: "CyberProjects" },
              ].map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
